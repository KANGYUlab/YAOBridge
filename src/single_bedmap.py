def single_bed_ref_2_query(bed,hit):
    yao_pos=[]
    interval=hit
    ...
    for pos in bed:
        ...
        for block in cigar:
            ...
            if r_curr <= pos < r_curr + size:
                ...
                yao_pos.append([pos, yao_name,final_yao_pos, strand, chain_info['score'],level])
                break # 找到即返回
            ...
            if len(block) == 3:
                ...
                if r_curr <= pos < r_curr + dt:
                    ...
                    yao_pos.append([pos, yao_name,str(final_yao_pos)+"Gap", strand, chain_info['score'],level])
                    break
...
def single_bed_query_2_ref(bed,hit):
    hg38_pos=[]
    ...
    # 1. 坐标归一化：把“倒着走”的负链坐标换算成“从头开始数”的进度
        ...
        for block in cigar:
            ...
            if curr_q <= target_q < curr_q + size:
                ...
                hg38_pos.append([pos,hg38_name,final_pos, strand, chain_info['score'],level])
            ...
            if len(block) == 3:
                ...
                if curr_q <= target_q < curr_q + dq:
                    ...
                    hg38_pos.append([pos,hg38_name,str(final_pos)+"Gap", strand, chain_info['score'],level])
